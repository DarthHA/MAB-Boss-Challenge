...
{
    public class EZStarFriendlyS : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.timeLeft % 9 == 2)
            {
                Projectile.NewProjectile(projectile.Center, (Main.rand.NextFloat() * MathHelper.TwoPi).ToRotationVector2() * 10, ModContent.ProjectileType<EZStarFriendly>(), projectile.damage, 0, Main.myPlayer);
                Projectile.NewProjectile(projectile.Center, (Main.rand.NextFloat() * MathHelper.TwoPi).ToRotationVector2() * 10, ModContent.ProjectileType<EZStarFriendly>(), projectile.damage, 0, Main.myPlayer);
            }
