...
{
    public class SuperStarFriendly : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (projectile.ai[0] % 40 == 19)
			{
				...
				{
					int protmp = Projectile.NewProjectile(projectile.Center + i.ToRotationVector2(), i.ToRotationVector2(), ModContent.ProjectileType<SuperStarSlashFriendly2>(), projectile.damage, 0, default, default, 1);
        ...
        private void SummonSuperStarSlash(Vector2 target)
		{
			...
			Projectile.NewProjectile(target - vector2 * 20f, vector2, ModContent.ProjectileType<SuperStarSlashFriendly>(), projectile.damage / 2, 0f, projectile.owner, 0f, target.Y);
		}
