...
{
    public class ShadowPlayerShadow : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            spriteBatch.Draw(tex, projectile.Center + new Vector2(0.25f, 0) * d - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), null, alpha, 0, tex.Size() / 2f, projectile.scale, SP, 0f);
            spriteBatch.Draw(tex, projectile.Center - new Vector2(0.25f, 0) * d - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), null, alpha, 0, tex.Size() / 2f, projectile.scale, SP, 0f);
            spriteBatch.Draw(tex, projectile.Center + new Vector2(0.5f, 0) * d - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), null, alpha, 0, tex.Size() / 2f, projectile.scale, SP, 0f);
            spriteBatch.Draw(tex, projectile.Center - new Vector2(0.5f, 0) * d - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), null, alpha, 0, tex.Size() / 2f, projectile.scale, SP, 0f);
