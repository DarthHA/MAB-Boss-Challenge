...
{
    public class HitExplosion : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Blood Explosion");
            DisplayName.AddTranslation(GameCulture.Chinese, "血之爆破");
        ...
        public override void OnHitPlayer(Player target, int damage, bool crit)
        {
            ...
            if (NPCUtils.BuffedEvilFighter()) target.AddBuff(BuffID.Dazed, 120);
